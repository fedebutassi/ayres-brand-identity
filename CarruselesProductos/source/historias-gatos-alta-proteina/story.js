const products = [
  { id: 'fawna-gatito', brand: 'FAWNA', protein: '39%' },
  { id: 'op-pn-kitten', brand: 'OLD PRINCE', protein: '38%' },
  { id: 'company-gatitos', brand: 'COMPANY', protein: '34%' },
  { id: 'kongo-gatitos-carne-leche', brand: 'KONGO', protein: '34%' },
];
...
const presentationMarkup = () => `
  <article class="story presentation">
    ...
    ${headerMarkup('light')}
    <section class="intro">
      <p>GATITOS · INFORMACIÓN NUTRICIONAL</p>
      <h1>GATOS CON ALTA<br>PROTEÍNA DECLARADA</h1>
...
const ctaMarkup = () => `
  <article class="story cta">
    ...
    <section class="chatbot-card" aria-label="Chatbot online AYRES">
      ...
      <div class="bubble bubble-two">Puedo orientarte según la etapa y las necesidades de tu gato.</div>
