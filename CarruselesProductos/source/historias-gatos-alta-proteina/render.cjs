...
const outputRoot = path.resolve(
  ...
  '..',
  '..',
  'coleccion-10-carruseles',
  '01-gatos-alta-proteina',
  'historias',
);
const jobs = [
  ['presentation', '01-presentacion-gatitos-alta-proteina-1080x1920.png'],
  ['cta', '02-cta-mas-informacion-gatitos-alta-proteina-1080x1920.png'],
];
