...
const outputRoot = path.join(repoRoot, 'AYRES-MKT-REFORMA', 'produccion', 'carruseles', '14-cuatro-alternativas-cachorros');
...
const slugs = ['portada', 'fawna-cachorro-pequeno', 'old-prince-pn-lamb-puppy', 'company-cachorros', 'kongo-gold-cachorros', 'tabla-comparativa', 'cta-catalogo'];
