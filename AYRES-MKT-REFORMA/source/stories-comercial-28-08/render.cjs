  ...
  stories: [
    {
      ...
      title: '¿TE FALTAN <em>MARCAS</em><br>EN LA GÓNDOLA<br>DE <em>PERROS?</em>',
      lede: 'Distribuidora mayorista de alimento balanceado.',
      options: ['PET SHOP', 'VETERINARIA', 'FORRAJERÍA'],
      hint: 'Respondé esta historia y contanos <em>qué marcas trabajás.</em>',
    },
    {
      light: true,
      badge: 'VARIEDAD PARA TU NEGOCIO',
      eyebrow: 'ESTA SEMANA · SECTOR PERROS',
      title: 'MARCAS Y LÍNEAS<br>PARA <em>PERROS.</em>',
      lede: 'Etapas, razas y presentaciones por mayor.',
      products: [
        product('voraz-perros-adultos-carne'),
        product('high-pro-criadores-perros-adultos'),
        product('maintenance-criadores-adulto'),
        product('origen-company-perro-adulto'),
      ],
      band: 'CONSULTÁ PRECIOS MAYORISTAS PARA TU LOCALIDAD',
    },
    {
      badge: 'CATÁLOGO MAYORISTA',
      eyebrow: 'UN SOLO CONTACTO',
      title: 'LISTA DE PRECIOS<br><em>POR MAYOR.</em>',
...
const outputRoot = path.join(repoRoot, 'AYRES-MKT-REFORMA', 'produccion', 'stories', 'comercial-28-08');
const chrome = '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';
const slugs = ['pregunta-gondola-perros', 'marcas-perros', 'cta-catalogo'];
