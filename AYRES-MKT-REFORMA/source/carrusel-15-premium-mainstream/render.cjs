...
const outputRoot = path.join(repoRoot, 'AYRES-MKT-REFORMA', 'produccion', 'carruseles', '15-premium-y-mainstream');
...
const slugs = ['portada', 'posicionamiento', 'formulas-ingredientes', 'variedad-surtido', 'presentaciones', 'oferta-equilibrada', 'cta-compartilo'];
