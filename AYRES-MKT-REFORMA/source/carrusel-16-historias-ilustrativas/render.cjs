...
const outputRoot = path.join(repoRoot, 'AYRES-MKT-REFORMA', 'produccion', 'carruseles', '16-historias-ilustrativas');
const chrome = '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';
const slugs = ['elena-mora', 'nicolas-petshop', 'paula-simon', 'ramiro-pipa-bruno', 'carolina-compara', 'luis-tano', 'escuchar-mejor'];
